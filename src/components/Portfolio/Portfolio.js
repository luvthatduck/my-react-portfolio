      ...
      <div className="images is-fullwidth">
        <div className="columns">
          <div className="column is-half ">
            ...
            <a class="image" className="image is-2by1 hover-zoom" href="https://avamariee.github.io/pet-adoption-quiz/" target="_blank" rel="noreferrer">
              <img
                src={DogsVsCats}
        ...
        <div className="columns">
          <div className="column is-half">
            <h2 class="title has-text-centered">The Tech Spot
              <a href="https://github.com/luvthatduck/Tech-Blog" target="_blank"><i class="fab fa-github icon is-large" href></i></a></h2>
            <a className="image is-2by1" href="https://fathomless-cove-73714.herokuapp.com/" target="_blank" rel="noreferrer">
              <img
                src={TechSpot}
          ...
          <div className="column is-half">
            ...
            <a className="image is-2by1" href="https://luvthatduck.github.io/work-day-scheduler/" target="_blank" rel="noreferrer">
              <img
                src={WorkDay}
